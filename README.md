...
Neste repositório é possível verificar os projetos de modelagem de banco de dados do curso "SQL Database Specialist" da DIO.

---

- [1. diagrama-ecommerce-dio](https://github.com/viniciushsp/dio-sql-db-specialist/blob/main/M%C3%B3dulo%202/diagrama-ecommerce-dio.png)
- [2. diagrama-os-oficina-dio](https://github.com/viniciushsp/dio-sql-db-specialist/blob/main/M%C3%B3dulo%202/diagrama-os-oficina-dio.png)
